- Homepage: At the beginning, show loading(all assets and scenes) then slowly show the globe and texts(fade in). At first keep the camera far from the camera then zom in and start rotating. And when hover over globe, show a green like effect. 
