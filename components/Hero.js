...
const Hero = () => {
    ...
    return (
        <main className='h-screen flex text-white bg-black relative'>
            ...
            <Globe redirect={() => router.push("/tour")} tour={tour} setFadeOut={setFadeOut} />
            <div className='absolute z-10 top-6/12 left-6/12 -translate-6/12 flex flex-col items-center gap-8 pointer-events-none'>
                ...
                <div className='flex gap-4'>
                    ...
                    <Button onClick={() => router.push("/login")} className={"text-black pointer-events-auto"} variant={"outline"}>Skip</Button>
                </div>
            </div>
        </main>
    )
