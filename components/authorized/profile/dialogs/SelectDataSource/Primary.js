...
export const Primary = ({ consentCheck, setConsentCheck, consentRef, consentTextRef, allDataSources, handleDataSourceClicked }) => {
    return <>
        ...
        <div className='social-media'>
            ...
            <div className='grid grid-cols-4 gap-4 py-4'>
                {allDataSources.map((dataSource, idx) => {
                    ...
                    return <Button key={idx} onClick={() => handleDataSourceClicked(dataSource.name)} variant={"outline"} className='border flex rounded-2xl justify-around items-center p-2'>
